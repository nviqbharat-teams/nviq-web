              ...
              <div>
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div>
                    ...
                    <a
                      href="https://maps.google.com/?q=NVIQ+BHARAT+TECHNOLOGY+PRIVATE+LIMITED+Wonder+Mall+Company+Bagh+Road+Katla+Sector+7+Alwar+Rajasthan+301001"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm font-semibold text-white underline underline-offset-4 hover:text-blue-200 transition-colors"
                    >
                      NVIQ BHARAT TECHNOLOGY PRIVATE LIMITED
                      <br />
                      320, 3rd floor, Wonder Mall, Company Bagh Road, Katla, Sector 7, Alwar, Rajasthan 301001
                    </a>
                  </div>
